...
@interface HotController ()<UITableViewDataSource,UITableViewDelegate>
...
- (CGRect)tableViewRect{
    ...
    return CGRectMake(0, 0, screentWidth(), TableViewH);
}
- (void)createTableView{
    
    self.tableView = [[UITableView alloc]initWithFrame:[self tableViewRect] style:UITableViewStylePlain];
