...
- (UIView *)onCreateView:(UIView *)parent{
    CCVRelativeLayout *lo_item_link = [CCVRelativeLayout layout];
    lo_item_link.layoutParams.width = CCVLayoutMatchParent;
    lo_item_link.layoutParams.height = CCVLayoutMatchParent;
    [parent addSubview:lo_item_link];
    
    wv_item = [[UIWebView alloc] init];
    wv_item.layoutParams.width = CCVLayoutMatchParent;
    wv_item.layoutParams.height = CCVLayoutMatchParent;
    ...
    btn_close.layoutParams.alignment = CCVLayoutAlignParentLeft | CCVLayoutAlignParentTop;
