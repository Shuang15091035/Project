...
#import <ctrlcv/ctrlcv_app.h>
#import <ctrlcv/ctrlcv_game.h>
...
typedef NS_ENUM(unsigned long, R_color_){
    R_color_suit_background = 0xff35c6ff,
    R_color_shape_background = 0xff35c6ff,
    R_color_room_base_background = 0xff35c6ff,
    R_color_product_name = 0x7f00654c,
    R_color_product_list_line = 0x7fffffff,
    R_color_option_info_n = 0xff999999, //物件详情选项按钮 未按下的颜色
    R_color_option_info_p = 0xff35c6ff, //物件详情选项按钮 按下的颜色
    R_color_product_price = 0xffe04a00,
    R_color_right_menu_label_textcolor = 0xff35c6ff,
    R_color_order_title_bg_color = 0xff35c6ff, // 0xff252525
    ...
    R_color_option_line = 0x9f95d2c2 ,
};
