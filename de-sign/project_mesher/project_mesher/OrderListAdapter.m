...
//    JWLinearLayout* view = [JWLinearLayout layout];
//    view.layoutParams.width = JWLayoutMatchParent;
//    view.layoutParams.height = JWLayoutMatchParent;
//    view.orientation = JWLayoutOrientationHorizontal;
//    [lo_view addSubview:view];
    ...
    img_image.layoutParams.alignment = JWLayoutAlignCenterVertical | JWLayoutAlignParentLeft;
    ...
    tv_name.layoutParams.alignment = JWLayoutAlignCenterVertical | JWLayoutAlignParentLeft;
    ...
    JWRelativeLayout* lo_count = [JWRelativeLayout layout];
    ...
    lo_count.layoutParams.alignment = JWLayoutAlignCenterVertical | JWLayoutAlignParentRight;
    ...
    img_bg_count.layoutParams.width = JWLayoutMatchParent;
    img_bg_count.layoutParams.height = JWLayoutMatchParent;
    [lo_count addSubview:img_bg_count];
    tv_count = [[UILabel alloc] init];
    tv_count.layoutParams.width = JWLayoutMatchParent;
    tv_count.layoutParams.height = JWLayoutMatchParent;
    ...
    tv_total.layoutParams.alignment = JWLayoutAlignCenterVertical | JWLayoutAlignParentRight;
    ...
    line.layoutParams.alignment = JWLayoutAlignParentBottom;
...
- (void) setRecord:(OrderItem*)orderItem {
    ...
    img_image.image = nil;
    if (item.preview != nil){
        [[JWCorePluginSystem instance].imageCache getBy:item.preview options:opt_img_image async:YES onGet:^(UIImage *image) {
...
//    JWLinearLayout* view = [[JWLinearLayout alloc] init];
//    view.layoutParams.width = JWLayoutMatchParent;
//    view.layoutParams.height = JWLayoutMatchParent;
//    view.orientation = JWLayoutOrientationHorizontal;
//    [lo_view addSubview:view];
    ...
    tv_area.layoutParams.width = JWLayoutWrapContent;
    tv_area.layoutParams.height = JWLayoutWrapContent;
    //tv_area.layoutParams.weight = 1;
    tv_area.layoutParams.alignment = JWLayoutAlignParentLeft | JWLayoutAlignCenterVertical;
    ...
    tv_total_text.layoutParams.alignment = JWLayoutAlignParentRight | JWLayoutAlignCenterVertical;
    ...
    tv_total.layoutParams.width = JWLayoutWrapContent;
    tv_total.layoutParams.height = JWLayoutWrapContent;
    tv_total.layoutParams.alignment = JWLayoutAlignParentRight | JWLayoutAlignCenterVertical;
...
@interface OrderListViewHolder : JWViewHolder {
...
- (NSUInteger)getViewTypeAt:(NSUInteger)position {
    JWObject* orderItem = [self getItemAt:position];
