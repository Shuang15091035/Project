...
//    mediump float px;
//    px.x = v_texcoord0.x * u_video_size.x;
//    px.y = v_texcoord0.y * u_video_size.y;
//    
//    mediump vec2 cen = vec2(u_video_size.x/2.0,u_video_size.y/2);
//    
//    mediump float distance = (cen.x - px.x) * (cen.x - px.x) + (cen.y - px.y) * (cen.y - px.y);
//    if (distance < 0.5 * 0.5) {
//        
//    }
//    
...
//    mediump float i = 0.0, j = 0.0;
//    for (i = 0.0; i < u_video_size.x; i+=1.0)
//    {
//        for (j = 0.0; j < u_video_size.y; j+=1.0)
//        {
...
#pragma mark 很有魔性的shader
//    mediump float r = horizEdge.r * horizEdge.r + vertEdge.r * vertEdge.r;
//    mediump float g = horizEdge.g * horizEdge.g + vertEdge.g * vertEdge.g;
//    mediump float b = horizEdge.b * horizEdge.b + vertEdge.b * vertEdge.b;
//    if (r > 0.07 * 0.07) {
//        r = 1.0 - r;
//    }else {
//        r = 1.0 - 0.07 * 0.07;
...
//    }
//    
//    gl_FragColor = vec4(r,g,b,1.0) + sf12;
//
}
