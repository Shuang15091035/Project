...
#pragma mark inspiratedPlan相关
- (BOOL) loadInspiratedPlans;
- (BOOL) saveInspiratedPlans;
- (InspiratedPlan*) createInspiratedPlan;
- (void) destoryInspiratedPlan:(Plan*)plan;
- (InspiratedPlan*) copyInspiratedPlan:(Plan*)plan;
- (InspiratedPlan*) inspiratedPlanAtIndex:(NSInteger)index;
- (JWFile*) getInspiratedBackgroundAtIndex:(NSInteger)index;
@property (nonatomic, readonly) NSInteger numInspiratedPlans;
@property (nonatomic, readwrite) NSMutableArray* inspiratedPlans; // 本地保存的所有方案
@property (nonatomic, readonly) NSInteger maxInspiratedPlanId;
