...
// 物件
@interface Item : JWSerializeObject
...
@property (nonatomic, readwrite) id<JIFile> previewSmall; // 缩略图小，用于产品列表
@property (nonatomic, readwrite) id<JIFile> previewBig; // 缩略图大，用于物件详情
