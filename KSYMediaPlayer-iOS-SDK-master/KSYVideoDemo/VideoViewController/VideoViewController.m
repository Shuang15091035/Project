...
-(void)touchBottomView:(UITapGestureRecognizer*)tap{
    [nativeField resignFirstResponder];
    [hlsField resignFirstResponder];
    [rtmpField resignFirstResponder];
}
- (void)viewDidLoad {
    [super viewDidLoad];
...
//    [self initPlayer];
    //为视图添加突出键盘手势
    UITapGestureRecognizer *tapGesture = [[UITapGestureRecognizer alloc]initWithTarget:self action:@selector(touchBottomView:)];
